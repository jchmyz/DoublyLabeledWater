...
export class DateRangePicker extends AbstractPureComponent {
    constructor(props, context) {
        ...
        this.handleShortcutClick = (shortcut) => {
            ...
            if (includeTime) {
                ...
                const nextState = getStateChange(this.state.value, dateRange, this.state, this.props.contiguousCalendarMonths);
    ...
    maybeRenderShortcuts() {
        ...
        return [
            React.createElement(Shortcuts, Object.assign({ key: "shortcuts" }, { allowSingleDayRange, maxDate, minDate, shortcuts }, { onShortcutClick: this.handleShortcutClick })),

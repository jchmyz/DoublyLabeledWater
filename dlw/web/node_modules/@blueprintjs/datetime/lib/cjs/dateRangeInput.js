...
var DateRangeInput = /** @class */ (function (_super) {
    ...
    function DateRangeInput(props, context) {
        ...
        _this.renderInputGroup = function (boundary) {
            ...
            return (React.createElement(core_1.InputGroup, tslib_1.__assign({ autoComplete: "off" }, inputProps, { disabled: _this.props.disabled, intent: _this.isInputInErrorState(boundary) ? core_1.Intent.DANGER : inputProps.intent, inputRef: _this.getInputRef(boundary), onBlur: handleInputEvent, onChange: handleInputEvent, onClick: handleInputEvent, onFocus: handleInputEvent, onKeyDown: handleInputEvent, onMouseDown: handleInputEvent, placeholder: _this.getInputPlaceholderString(boundary), value: _this.getInputDisplayString(boundary) })));
        };

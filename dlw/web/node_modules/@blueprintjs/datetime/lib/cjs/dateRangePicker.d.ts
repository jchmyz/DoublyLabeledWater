...
import { AbstractPureComponent, Boundary, IProps } from "@blueprintjs/core";
...
export declare class DateRangePicker extends AbstractPureComponent<IDateRangePickerProps, IDateRangePickerState> {
    ...
    private renderCalendars(isShowingOneMonth);

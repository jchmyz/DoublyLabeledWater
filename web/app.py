...
def calculate_from_inputs():
    ...
    return json.dumps({
        ...
        "schoeller": {
            "rco2_ee_int": {
                "rco2_mol_day": ["rCO2 (mol/day)", round(CALCULATED_RESULTS.schoeller_co2_int_mol_day, 2)],
                "rco2_l_hr": ["rCO2 (L/day)", round(CALCULATED_RESULTS.schoeller_co2_int_L_day, 1)],
                "ee_kcal_day": ["EE (kcal/day)", round(CALCULATED_RESULTS.schoeller_tee_int_kcal_day, 1)],
                "ee_mj_day": ["EE (MJ/day)", round(CALCULATED_RESULTS.schoeller_tee_int_mj_day, 2)]
            },
            "rco2_ee_plat": {
                "rco2_mol_day": ["rCO2 (mol/day)", round(CALCULATED_RESULTS.schoeller_co2_plat_mol_day, 2)],
                "rco2_l_hr": ["rCO2 (L/day)", round(CALCULATED_RESULTS.schoeller_co2_plat_L_day, 1)],
                "ee_kcal_day": ["EE (kcal/day)", round(CALCULATED_RESULTS.schoeller_tee_plat_kcal_day, 1)],
                "ee_mj_day": ["EE (MJ/day)", round(CALCULATED_RESULTS.schoeller_tee_plat_mj_day, 2)]
            }
        },
        "error_flags": {

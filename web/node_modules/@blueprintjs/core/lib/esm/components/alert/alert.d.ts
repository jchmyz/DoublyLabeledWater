...
import { AbstractPureComponent, Intent, IProps } from "../../common";
...
export declare class Alert extends AbstractPureComponent<IAlertProps, {}> {
    ...
    private internalHandleCallbacks(confirmed, evt?);
}

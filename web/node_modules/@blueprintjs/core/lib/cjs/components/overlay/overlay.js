...
var Overlay = /** @class */ (function (_super) {
    ...
    Overlay.prototype.render = function () {
        ...
        var _a = this.props, children = _a.children, className = _a.className, usePortal = _a.usePortal, portalContainer = _a.portalContainer, isOpen = _a.isOpen;
        ...
        if (usePortal) {
            return React.createElement(portal_1.Portal, { container: portalContainer }, transitionGroup);
        }
        else {

...
import { AbstractPureComponent, Boundary, HTMLInputProps, IInputGroupProps, IPopoverProps, IProps } from "@blueprintjs/core";
...
export declare class DateRangeInput extends AbstractPureComponent<IDateRangeInputProps, IDateRangeInputState> {
    ...
    private isNextDateRangeValid(nextDate, boundary);

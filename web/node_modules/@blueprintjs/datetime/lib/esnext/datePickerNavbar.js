...
export class DatePickerNavbar extends React.PureComponent {
    constructor() {
        super(...arguments);
        this.handleNextClick = () => this.props.onNextClick();
        this.handlePreviousClick = () => this.props.onPreviousClick();
    }
    render() {

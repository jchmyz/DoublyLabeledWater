...
var DateRangePicker = /** @class */ (function (_super) {
    ...
    function DateRangePicker(props, context) {
        ...
        _this.renderNavbar = function (navbarProps) { return (React.createElement(datePickerNavbar_1.DatePickerNavbar, tslib_1.__assign({}, navbarProps, { maxDate: _this.props.maxDate, minDate: _this.props.minDate }))); };
    ...
    DateRangePicker.prototype.renderCalendars = function (isShowingOneMonth) {
        ...
        if (contiguousCalendarMonths || isShowingOneMonth) {
            return (React.createElement(react_day_picker_1.default, tslib_1.__assign({}, dayPickerBaseProps, { captionElement: this.renderSingleCaption, navbarElement: this.renderNavbar, fromMonth: minDate, month: this.state.leftView.getFullDate(), numberOfMonths: isShowingOneMonth ? 1 : 2, onMonthChange: this.handleLeftMonthChange, toMonth: maxDate })));
        }
        else {
            return [
